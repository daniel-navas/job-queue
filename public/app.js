...
function summaryHTML(job) {
  ...
  const names = { roleFocus: 'Role focus', salary: 'Salary', companyType: 'Company type', requirements: 'Requirements', preferred: 'Nice to have', experience: 'Experience', language: 'Language', workplace: 'Work mode', project: 'Project', culture: 'Work culture' };
